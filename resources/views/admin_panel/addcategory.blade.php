                ...
                <div class="col-md-9">
                    ...
                    <div style="border: 1px solid navyblue;">
                      ...
                      <h2>All Category</h2>
                        ...
                        <li class="mt-4 mb-4">{{$categoryAll->category}} <span>
                          <a href="{{url('category-edit/'.$categoryAll->category_id)}}" class="btn btn-primary">Edit</a> | 
                          <a href="{{url('category-delete/'.$categoryAll->category_id)}}" class="btn btn-danger">Delete</a>
                        </span>
                      </li>
